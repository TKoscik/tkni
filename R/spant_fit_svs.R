...
#' }
#' @export
spant_fit_svs <- function(input, w_ref = NULL, output_dir = NULL,
  ...
  if (spant:::is.def(w_ref) & (class(w_ref)[[1]] != "mrs_data")) {
  ...
  saveRDS(results, file=file.path(tools::file_path_as_absolute(output_dir), "svs_results.rds"))
  saveRDS(argg, file=file.path(tools::file_path_as_absolute(output_dir), "svs_argg.rds"))
